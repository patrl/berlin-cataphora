...
\ex.
  Every [\textsubscript{NP} man who had \tikz[na]{\node[fill=green!10](novel5){a {\sc Russian} novel};}] [\textsubscript{VP} read \tikz[na]{\node[](it5){\textcolor{green}{\bf it}};}], and\\
  every [\textsubscript{NP} man who had \tikz[na]{\node[fill=green!10](novel6){a {\sc German} novel};}] [\textsubscript{VP} did \elide{read \tikz[na]{\node[](it6){\textcolor{green}{\bf it}};}}], too.\\
...
\begin{frame}{Sloppy cataphoric donkeys}
